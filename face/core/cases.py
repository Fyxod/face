"""Case selection and MAT image auto-detection for FACE."""
...
class RunSpec:
    ...
    @property
    def slug(self) -> str:
        return f"arcface_identity__{self.case.slug}"
...
def print_resolved_cases(mat_root: Path) -> None:
    for face_id in FACES:
        ...
        print(f"[face] input {face_id}: {path}")
